...
public class List14 extends ListActivity {
    ...
    private static final String TAG = "List14";
...
//				count += 10;
//			}
        	LogUtils.logStringArray(TAG, "getCount", count+"");
        	return count;
//            return DATA.length;
        }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button btnMore = new Button(List14.this);
        
        btnMore.setOnClickListener( new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				Toast.makeText(context, "the more data", Toast.LENGTH_LONG).show();
				count += 10;
				...
				LogUtils.logStringArray(TAG, "onClickButton.count", count+"");
			}
		});
//        View view;
		listView.addFooterView(btnMore,null,false);
